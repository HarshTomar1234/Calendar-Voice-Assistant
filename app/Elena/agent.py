...
root_agent = Agent(
    ...
    description="Elena is a calendar assistant that can help you manage your calendar events",
    instruction=f"""
    You are Elena, a calendar assistant that can help you manage your calendar events. 
    You can create, delete, edit, and list events.
    You can help with scheduling and calendar operations.
